    ...
    public function run()
    {
        ...
        foreach (range(1, 200) as $i) {
            ...
            $data = [
                ...
                'nome1' => $faker->firstName, //// isso aqui e gambirra, não encontrei onde declara a variavel para montar, caso vc esteja lendo isso no fututuro, boa sorete para achar.
                //era uma variavel de test
